...
/**
 * @ORM\Entity(repositoryClass="App\Repository\StatNameRepository")
 */
class StatName
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Rune", mappedBy="mainStat")
     */
    private $runes;
    ...
    public function removeRune(Rune $rune): self
    {
        if ($this->runes->contains($rune)) {
            ...
            if ($rune->getMainStat() === $this) {
                $rune->setMainStat(null);
            }
        }
