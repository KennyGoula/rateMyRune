...
/**
 * @ORM\Entity(repositoryClass="App\Repository\RuneSetNameRepository")
 */
class RuneSetName
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Rune", mappedBy="runeSet")
     */
    private $runes;
    ...
    public function removeRune(Rune $rune): self
    {
        if ($this->runes->contains($rune)) {
            ...
            if ($rune->getRuneSet() === $this) {
                $rune->setRuneSet(null);
            }
        }
